...
# this file will be auto created during boot. 

# see: http://www.linuxfromscratch.org/lfs/view/6.3/chapter07/network.html

echo > /etc/udev/rules.d/70-persistent-net.rules

if ! grep -sq '70-persistent-net.rules' /etc/rc.local; then
